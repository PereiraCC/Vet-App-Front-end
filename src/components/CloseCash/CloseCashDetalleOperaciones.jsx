...
export const CloseCashDetalleOperaciones = () => {
    return (
        <div className='closeCash_detalleOperaciones-main'>

            <div className='closeCash_detalleOperaciones-title'>
                <p>Detalles Operaciones</p>
            </div>

            <div className='closeCash_detalleOperaciones-table'>
